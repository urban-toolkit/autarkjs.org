...
> **CsvGeometryLayerType** = `Extract`\<[`LayerType`](LayerType.md), `"points"` \| `"polylines"` \| `"polygons"`\>

Defined in: [autk-db/src/use-cases/load-csv/interfaces.ts:103](https://github.com/urban-toolkit/autark/blob/2086406f6ed56aea8faab9b6b840f71fa86be019/autk-db/src/use-cases/load-csv/interfaces.ts#L103)
