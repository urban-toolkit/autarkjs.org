...
gtag('config', 'G-P6EVSF42L8');`],
    ...
    vite: {
        ...
        plugins: [
            {
                name: 'strip-duckdb-sourcemap-url',
                enforce: 'pre',
                transform(code, id) {
                    if (id.includes('duckdb-browser-eh.worker.js')) {
        ...
        sidebar: {
                ...
                items: [
                    ...
                    },
                    {
                        text: 'Interfaces', collapsed: true, items: [
                            ...
                            { text: 'HeatmapGroupBy', link: '/api/autk-db/interfaces/HeatmapGroupBy' },
                    ...
                    },
                    {
                        text: 'Type Aliases', collapsed: true, items: [
                            ...
                            { text: 'GetTableOutput', link: '/api/autk-db/type-aliases/GetTableOutput' },
            ...
            '/api/autk-core/': [{
                ...
                items: [
                    ...
                    {
                        text: 'Type Aliases', collapsed: true, items: [
                            { text: 'CategoricalDomain', link: '/api/autk-core/type-aliases/CategoricalDomain' },
                            ...
                            { text: 'DivergingDomain', link: '/api/autk-core/type-aliases/DivergingDomain' },
                            ...
                            { text: 'SequentialDomain', link: '/api/autk-core/type-aliases/SequentialDomain' },
                ...
                items: [
                    ...
                    },
                    {
                        text: 'Interfaces', collapsed: true, items: [
                            ...
                            { text: 'LoadCollectionConfig', link: '/api/autk-map/interfaces/LoadCollectionConfig' },
            ...
            '/': [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { text: 'Layers Data', link: '/autk-map/layers' },
                        { text: 'Terrain Data', link: '/autk-map/terrain' },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { text: 'Property Computation', link: '/autk-compute/computing-properties' },
                        { text: 'Render Analysis', link: '/autk-compute/render-analysis' },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { text: 'Transformations', link: '/autk-plot/transformations' },
                ...
                },
                {
                    ...
                    collapsed: false,
                    items: [
                        { text: 'GeoJSON Layer', link: '/gallery/ex1' },
                        { text: 'Categorical Data', link: '/gallery/ex2' },
                        { text: 'OSM Layers', link: '/gallery/ex3' },
                        { text: 'Linked Views', link: '/gallery/ex4' },
                        { text: 'GPU Computation', link: '/gallery/ex5' },
                        { text: 'Layer Overlay', link: '/gallery/ex6' },
                        { text: '3D Picking', link: '/gallery/ex7' },
                        { text: 'Scatterplot', link: '/gallery/ex8' },
                        { text: 'Bar Chart', link: '/gallery/ex9' },
                        { text: 'Spatial Join', link: '/gallery/ex10' },
                        { text: 'Parallel Coords', link: '/gallery/ex11' },
                        { text: 'Sky Exposure', link: '/gallery/ex15' },
                        { text: 'Visibility', link: '/gallery/ex16' },
                        { text: 'View Score', link: '/gallery/ex17' },
                    ],
                },
            ],
        },
