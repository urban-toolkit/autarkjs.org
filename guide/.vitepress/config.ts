        ...
        nav: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'Neighborhood Explorer', link: '/gallery/ex1' },
                    { text: 'Road Classes', link: '/gallery/ex2' },
                    { text: 'City Stack', link: '/gallery/ex3' },
                    { text: 'Neighborhood Bars', link: '/gallery/ex4' },
                    { text: 'Computed Neighborhoods', link: '/gallery/ex5' },
                    { text: 'Points over Polygons', link: '/gallery/ex6' },
                    { text: 'Building Picker', link: '/gallery/ex7' },
                    { text: 'Area Scatter', link: '/gallery/ex8' },
                    { text: 'Neighborhood Histogram', link: '/gallery/ex9' },
                    { text: 'Road Event Timeline', link: '/gallery/ex10' },
                ],
            },
            {
                text: 'Use Cases',
