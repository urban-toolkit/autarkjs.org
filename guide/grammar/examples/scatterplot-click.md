...
Plot neighborhood area against perimeter and click points to select the matching neighborhoods.
...
- `mark: 'scatter'`
- click selection shared with the map

This example comes from the [autk-grammar repository](https://github.com/urban-toolkit/autk-grammar/blob/main/gallery/src/examples/scatterplot-click.ts).
